...
def main():
    ...
    if mode == 'train':
        ...
        files = {
            "GCN w/ PE": "./benchmark/results_gnn_pos.csv",
            "UNet (padded)": "./benchmark/results_unet.csv",
            "GCN w/o PE": "./benchmark/results_gnn_wo_pos.csv",
        }
        ...
        # 1) Distribution
        plot_metric_distribution(df_all, metric="rmsd", add_ref_lines=False, figsize=(4, 3), save_path="./benchmark/rmsd_dist.png")
        plot_metric_distribution(df_all, metric="tm", add_ref_lines=False, figsize=(4, 3), save_path="./benchmark/tm_dist.png")

        # 2) Box / Violin
        plot_metric_box_violin(df_all, metric="rmsd", kind="box", add_ref_lines=False, figsize=(3, 3), save_path="./benchmark/rmsd_box.png")
        plot_metric_box_violin(df_all, metric="tm", kind="box", add_ref_lines=False, figsize=(3, 3), save_path="./benchmark/tm_box.png")

        # 3) Scatter vs. L with trend lines
        plot_metric_vs_length(df_all, metric="rmsd", add_linear_trend=True, add_ref_lines=False, figsize=(3.8, 3.7), save_path="./benchmark/rmsd_vs_L.png")
        plot_metric_vs_length(df_all, metric="tm", add_linear_trend=True, add_ref_lines=False, figsize=(3.8, 3.7), save_path="./benchmark/tm_vs_L.png")
    else:
