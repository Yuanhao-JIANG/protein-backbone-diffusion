...
% Here should be some intro to GNN model architecture. by \citep{scarselliGraphNeuralNetwork2009}.
...
where spatial context determines structural validity. % should improve this: why it is useful to use attention, what does it impeoved in general
